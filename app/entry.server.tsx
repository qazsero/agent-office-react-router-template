...
import { type AppLoadContext, type EntryContext, RouterContextProvider, ServerRouter } from "react-router";

import { log, patchConsoleToPino } from "~/lib-server/logger.server";
    ...
    const { pipe, abort } = renderToPipeableStream(
      <ServerRouter context={reactRouterContext} url={request.url} />,
      {
        ...
        onError(error: unknown) {
          ...
          if (shellRendered) {
            log.error(
              "React streaming rendering error inside shell",
